...
# Take, for example, a convolutional code with constraint length 3.
ex_fsa = {
  '00' => [
    { 'new' => '00', 'out' => '00' },
    { 'new' => '10', 'out' => '11' }
...
# Each key is a state, and each value is a list of strings
# representing the new state upon an input (the index).
